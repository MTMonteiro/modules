...
DEFAULT_PACKAGES:=base-files iw iptables kernel libc libgcc busybox dropbear mtd uci opkg netcat netifd fstools hostapd hostapd-common snmp-utils snmpd wireless-tools uhttpd kmod-ath kmod-ath9k kmod-ath9k-common kmod-cfg80211 kmod-dnsresolver kmod-fs-nfs kmod-fs-nfs-common kmod-gpio-button-hotplug kmod-mac80211 kmod-ipt-core kmod-ipt-nat kmod-nf-conntrack kmod-nf-ipt kmod-nf-nat kmod-nf-nathelper nfs-utils procd swconfig uboot-envtools ubox ubus ubusd usign logd SPPH
# For nas targets
DEFAULT_PACKAGES.nas:=block-mount fdisk lsblk mdadm
# For router targets
DEFAULT_PACKAGES.router:=dnsmasq iptables ip6tables odhcpd odhcp6c
