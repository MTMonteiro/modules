...
DEFAULT_PACKAGES:=base-files libc libgcc busybox dropbear mtd uci opkg netifd fstools uclient-fetch logd hostapd  wireless-tools uhttpd  openssl-util libmbedtls px5g-standalone libustream-openssl php7 php7-cgi ca-bundle curl
# For nas targets
DEFAULT_PACKAGES.nas:=block-mount fdisk lsblk mdadm
# For router targets
DEFAULT_PACKAGES.router:=dnsmasq iptables firewall odhcpd-ipv6only odhcp6c
