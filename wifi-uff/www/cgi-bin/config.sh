...
echo ""
echo "<head>"
echo "<TITLE> Configurar AP </TITLE>"
echo "</head>"
echo "<body>"
echo "<H1> Configurar AP </H1>"
echo "Configurar AP"
echo ""
echo ""
echo ""
...
echo "<option value=\"GR-GRAGOATA\">Gragoata</option>"
echo "<option value=\"HU-HUAP\">HUAP</option>"
echo "<option value=\"PV-PRAIA_VERMELHA\">Praia Vermelha</option>"
echo "<option value=\"VL-VALONGUINHO\">Valonguinho</option>"
echo "<option value=\"RT-REITORIA\">Reitoria</option> "
echo "<option value=\"DI-DIREITO\">Direito</option> "
echo "<option value=\"EC-ECONOMIA\">Economia</option> "
echo "<option value=\"VE-VETERINARIA\">Veterinaria</option> "
echo "<option value=\"FA-FARMACIA\">Farmacia</option> "
echo "<option value=\"IA-IACS\">IACS</option> "
echo "<option value=\"EN-ENFERMAGEM\">Enfermagem</option> "
echo "<option value=\"OU-OUTRO\">Outro</option> "

echo "</select>"
echo "<br>"
echo ""
echo "<br>"
echo "Departamento:  <input type=\"text\" name=\"Dept\" value=\"BLOCO_X\"> <br>"
echo "Local:  <input type=\"text\" name=\"sala\" value=\"Sala_YYY\"> <br>"
echo "<br>"
echo "<br>"
...
echo "<br>"
echo "<br>"
echo "IP do switch:  <input type=\"text\" name=\"SwIp\" value=\"switch\"> <br>"
echo ""
